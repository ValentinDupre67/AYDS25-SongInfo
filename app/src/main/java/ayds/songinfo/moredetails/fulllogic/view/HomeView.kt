...
//    private lateinit var lastFMAPI: LastFMAPI
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initViewProperties()
        //initArticleDatabase() //ya esta
        //initLastFMAPI() // ya esta
        getArtistInfoAsync()
    }
...
//    }
    ...
    //esta mal? por que estas haciendo un get de la info del artista, pero tambien estas actualizando la ui desde una funcion getArtistInfo()
    private fun getArtistInfo() {
        //val artistBiography = getArtistInfoFromRepository()
        val artistBiography = homeModel.getArtistInfoFromRepository(getArtistName())
